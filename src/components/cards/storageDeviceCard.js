      ...
      <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
        ...
        <div>
          ...
          <p className="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">
            WriteSpeed: {singleProduct.KeyFeatures.WriteSpeed}
          </p>
          <p className="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">
            ReadSpeed: {singleProduct.KeyFeatures.ReadSpeed}
          </p>
          <p className="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">
        ...
        <div>
          <div className="border-b py-4 border-gray-200">
            ...
            >
              <p>Model : {singleProduct.KeyFeatures.Model}</p>
              <p>Interface : {singleProduct.KeyFeatures.Interface}</p>
              <p>Type : {singleProduct.KeyFeatures.Type}</p>
              <p>ResponseTime : {singleProduct.KeyFeatures.ResponseTime}</p>
              <p>Capacity : {singleProduct.KeyFeatures.Capacity}</p>
            </div>
          </div>
        </div>
      </div>
